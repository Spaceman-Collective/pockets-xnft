...
export const SelectNFT: FC<{
	...
	return (
		<Flex direction="column" justifyContent="space-between" minH="60vh">
			...
			<Box>
				<Text>
					Select from one of your <strong>NFTs</strong> from the above collections to
					create a Character with. You will be asked to sign a message on the next
					screen to confirm.
				</Text>
	...
	return (
		<>
			{Array.from({ length: 4 }).map((_, i) => (
				<Skeleton key={"loading" + i} h="100px" w="100px" borderRadius="0.5rem" />
			))}
		</>
	)
}
