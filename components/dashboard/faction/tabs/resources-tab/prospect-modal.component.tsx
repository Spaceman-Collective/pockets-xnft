	...
	return (
		<Modal isOpen={isOpen} onClose={onClose} isCentered>
			...
			>
				...
				>
					<Text>
						Take a chance to claim this resource field for your faction. Even if you
						fail, you increase chance the next transaction will successfully claim the
						resource field. CURRENTLY NOT SUPPORTED ON LEDGER.
					</Text>
					<br></br>
					...
					{jackpot ? (
						...
						>
							<Text>
								Congrats, anon! <br />
								You have claimed the resource field for your faction! This field has
								been added to your factions resource fields.
							</Text>
						</VStack>
					) : (
						<VStack pt="28">
							...
							<Flex gap={"6"} justifyContent={"center"} my="2rem">
								...
								<StyledInput
									...
									type="number"
									onChange={(event) => setNumProspectTickets(Number(event.target.value))}
								/>
								<Button
									w="24"
